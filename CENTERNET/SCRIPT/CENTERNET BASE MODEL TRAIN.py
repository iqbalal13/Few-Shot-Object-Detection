...
BELUM menggunakan dataset COCO.

TUJUAN:
--------
- memastikan model benar-benar bisa belajar
- memastikan loss bisa turun
- memastikan training pipeline stabil
"""
...
print("Optimizer berhasil dibuat!\n")
...
print("Mulai training validation...\n")
...
for epoch in range(epochs):
    ...
    wh_target = torch.randn(
        2, 2, 32, 32
    ).to(device)

    offset_target = torch.randn(
        2, 2, 32, 32
    ).to(device)
    ...
    print(f"WH Loss       : {wh_loss.item():.4f}")
...
print("\n====================================")
print("TRAINING VALIDATION BERHASIL!")
print("MODEL SUDAH TRAINABLE")
print("====================================")
